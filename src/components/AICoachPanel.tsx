...
> = {
  good:      { icon: '✅', label: 'Good move',    className: 'border-emerald-300 dark:border-emerald-600 bg-emerald-50 dark:bg-emerald-950/40' },
  optimal:   { icon: '🎯', label: 'Optimal',      className: 'border-violet-300 dark:border-violet-600 bg-violet-50 dark:bg-violet-950/40' },
  risky:     { icon: '⚠️', label: 'Risky move',   className: 'border-yellow-300 dark:border-yellow-600 bg-yellow-50 dark:bg-yellow-950/40' },
  impulsive: { icon: '💥', label: 'Impulsive',    className: 'border-red-300 dark:border-red-600 bg-red-50 dark:bg-red-950/40' },
};
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <div className="w-full max-w-lg max-h-[90vh] overflow-y-auto rounded-2xl
        ...
        {/* Header */}
        <div className={`px-6 py-5 rounded-t-2xl ${won ? 'bg-emerald-100 dark:bg-emerald-900/60' : 'bg-red-100 dark:bg-red-900/60'}`}>
        ...
        <div className="px-6 py-4 border-t border-gray-200 dark:border-gray-700 flex gap-3">
          ...
          <button
            ...
            className="flex-1 py-2.5 rounded-xl bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600
              text-gray-700 dark:text-gray-200 font-semibold text-sm transition-colors border border-gray-200 dark:border-gray-600"
          >
            My Profile
          </button>
        </div>
